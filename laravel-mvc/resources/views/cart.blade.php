...
<html lang="es" dir="ltr">
  ...
  <body>
    ...
    <header class="header">
       <a class="logo" href="/home"><img class="logotipo" src="{{asset('img/Logo1.png')}}" alt="logo"></a>
        <nav>
            <ul class="nav__links">
              <li><a href="/cat" class="opciones bars-solid"><svg class="bars-solid"  xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" width="30px" height="40px"><path  fill=currentcolor d="M 0 7.5 L 0 12.5 L 50 12.5 L 50 7.5 Z M 0 22.5 L 0 27.5 L 50 27.5 L 50 22.5 Z M 0 37.5 L 0 42.5 L 50 42.5 L 50 37.5 Z"/></svg> Categorias</a></li>
   ...
   {{Cart::getContent()->count()}}
    ...
    <div class="overlay" id="mobile-menu">
        ...
        <div class="overlay__content">
            ...
            <a href="{{route('acerca')}}">Conocenos</a>
...
<div class="container">
<h1 class="text-center h2 pt-3 pb-3" style="margin-top:5%; font-weight:bold">Tu Carrito tiene</h1>
<center>
<form method="POST" action="{{route('cart.clear')}}" enctype="multipart/form-data" >
  @csrf  
  <input name="id" type="hidden" value="" >
  <button type="submit" class="btn btn-warning btn-clean"   title="" class="clean-cart"><i class="fas fa-ban"></i> Limpiar carrito</button>

</form>
<br>
<br>
<a href="/paga" >
  <button type="button" class="btn btn-danger btn-lg border border-1" style="border:none;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="28px" height="40px"><path fill="currentColor" d="M320 96H192L144.6 24.88C137.5 14.24 145.1 0 157.9 0H354.1C366.9 0 374.5 14.24 367.4 24.88L320 96zM192 128H320C323.8 130.5 328.1 133.3 332.1 136.4C389.7 172.7 512 250.9 512 416C512 469 469 512 416 512H96C42.98 512 0 469 0 416C0 250.9 122.3 172.7 179 136.4C183.9 133.3 188.2 130.5 192 128V128zM276.1 224C276.1 212.9 267.1 203.9 255.1 203.9C244.9 203.9 235.9 212.9 235.9 224V230C230.3 231.2 224.1 232.9 220 235.1C205.1 241.9 192.1 254.5 188.9 272.8C187.1 283 188.1 292.9 192.3 301.8C196.5 310.6 203 316.8 209.6 321.3C221.2 329.2 236.5 333.8 248.2 337.3L250.4 337.9C264.4 342.2 273.8 345.3 279.7 349.6C282.2 351.4 283.1 352.8 283.4 353.7C283.8 354.5 284.4 356.3 283.7 360.3C283.1 363.8 281.2 366.8 275.7 369.1C269.6 371.7 259.7 373 246.9 371C240.9 370 230.2 366.4 220.7 363.2C218.5 362.4 216.3 361.7 214.3 361C203.8 357.5 192.5 363.2 189 373.7C185.5 384.2 191.2 395.5 201.7 398.1C202.9 399.4 204.4 399.9 206.1 400.5C213.1 403.2 226.4 407.4 235.9 409.6V416C235.9 427.1 244.9 436.1 255.1 436.1C267.1 436.1 276.1 427.1 276.1 416V410.5C281.4 409.5 286.6 407.1 291.4 405.9C307.2 399.2 319.8 386.2 323.1 367.2C324.9 356.8 324.1 346.8 320.1 337.7C316.2 328.7 309.9 322.1 303.2 317.3C291.1 308.4 274.9 303.6 262.8 299.9L261.1 299.7C247.8 295.4 238.2 292.4 232.1 288.2C229.5 286.4 228.7 285.2 228.5 284.7C228.3 284.3 227.7 283.1 228.3 279.7C228.7 277.7 230.2 274.4 236.5 271.6C242.1 268.7 252.9 267.1 265.1 268.1C269.5 269.7 283 272.3 286.9 273.3C297.5 276.2 308.5 269.8 311.3 259.1C314.2 248.5 307.8 237.5 297.1 234.7C292.7 233.5 282.7 231.5 276.1 230.3L276.1 224z"/></svg> Pagar</button>
</a>
</center>
...
<thead class="table-dark">
  <tr>
    ...
    <th scope="col"><p class="text-center m-0" style="text-align:center;">OPCIONES</p></td>
    <th></th>
  </tr>
</thead>
<tbody>
  ...
  <div class="d-flex justify-content-center">
      <form method="POST" action="{{route('cart.removeqty')}}" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-primary" title="" style="margin-left:-28%"><i class="fas fa-minus-circle"></i></button>
      </form>
      <input name="quantity" type="number" value="{{$p->quantity}}" min="1" max="999" readonly style="text-align:center">
      <form method="POST" action="{{route('cart.addqty')}}" enctype="multipart/form-data">
        @csrf  
        <input name="id" type="hidden" value="{{$p->id}}" >
        <button type="submit" class="btn btn-primary" title="" style="margin-left:28%"><i class="fas fa-plus-circle"></i></button>
      </form>
    </div>
  </td>
  <td style="text-align:center;">
    ...
    <footer class="pie-pagina">
        <div class="grupo-1">
            <div class="box">
                <figure>
                    <a href="#">
                        <img src="{{asset('img/Gonly.png')}}" alt="Logo de GONLY">
                    </a>
                </figure>
            </div>
            <div class="box">
