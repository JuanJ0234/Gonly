...
<head>
    ...
    <link rel="preload" type="text/css" href="{{asset('css/all-product.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/all-product.css')}}">
...
<br>
 ...
 <div class="producto">
    ...
    <img src="/productos/{{$productos->image_path}}" height="180px" width="200px" alt="tarjeta grafica"> </a>
     <div class="informacion">
    
        <span class="precio"> ${{$productos->precio}}</span>
        <span class="descripcion">{{$productos->nombre}}</span>
...
<footer class="pie-pagina">
        ...
        <div class="grupo-2">
            <small>&copy; 2022 <b>GONLY</b> | Todos los Derechos Reservados</small>
