...
<head>
    ...
    <link rel="stylesheet" href="../../css/categoria-2.css">
    ...
    <title>spirit_store | Todo Terreno</title>
</head>
<body>
<script src="../../JS/DecoScript-3.js"></script>
    ...
    <section>
        <div class="objets-container">
            <div class="location">
              <p> Pagina Principal  /  Deportivos</p>
            </div>
            <div class="title-up">
                <h1>Deportivos</h1>
            </div>
            <div class="objet-div">
                <div class="big-file">
                    <div class="file">
                        ...
                        <img src="../../resource/categories/categoria5/imagenes-portada/subaru.jpg" alt="">
                            <a href="#">
                            ...
                            <h1>Subaru WRX Base</h1>
                                <br>
                                <p class="text-boxes">$ 18.900</p>
                            </div>
                        </div>
                        <div class="objet objet2">
                        <img src="../../resource/categories/categoria5/imagenes-portada/honda-civic.jpg" alt="">
                            <a href="#">
                                <div class="images-categories">
                                    <h1>Ver Más</h1>
                                </div>
                            ...
                            <h1>Honda Civic Si</h1>
                                <br>
                                <p class="text-boxes">$ 19.997</p>
                            </div>
                        </div>
                        <div class="objet">
                        <img src="../../resource/categories/categoria5/imagenes-portada/audi.jpg" alt="">
                            <a href="#">
                                <div class="images-categories">
                                    <h1>Ver Más</h1>
                                </div>
                            ...
                            <div class="objet1-text">
                            <h1>Audi 2.0T Premium Plus</h1>
                                <br>
                                <p class="text-boxes">$ 19.000</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="big-file-2">
                    <div class="file">
                        <div class="objet objet1">
                        <img src="../../resource/categories/categoria5/imagenes-portada/scion.jpg" alt="">
                            <a href="#">
                                <div class="images-categories">
                                    <h1>Ver Más</h1>
                                </div>
                            ...
                            <div class="objet1-text">
                            <h1>Scion FR-S Base</h1>
                                <br>
                                <p class="text-boxes">$ 17.500</p>
                            </div>
                        </div>
                        <div class="objet objet2">
                        <img src="../../resource/categories/categoria5/imagenes-portada/hyundai-genesis.jpg" alt="">
                            <a href="#">
                                <div class="images-categories">
                                    <h1>Ver Más</h1>
                                </div>
                            ...
                            <div class="objet1-text">
                            <h1>Hyundai Genesis Coupe</h1>
                                <br>
                                <p class="text-boxes">$ 13.000</p>
                            </div>
                        </div>
                        <div class="objet">
                        <img src="../../resource/categories/categoria5/imagenes-portada/Mercedes.jpg" alt="">
                            <a href="#">
                                <div class="images-categories">
                                    <h1>Ver Más</h1>
                                </div>
