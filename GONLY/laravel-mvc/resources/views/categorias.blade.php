...
<head>
    ...
    <link rel="preload" type="text/css" href="{{asset('css/catalogo.css')}}">
...
<main>
    ...
    <header class="header">
       <a class="logo" href="/home"><img class="logotipo" src="img/Logo1.png" alt="logo"></a>
        <nav>
            <ul class="nav__links">
...
<div class="title">
<h1>CATEGORIAS</h1>
<center>  <hr class=" border-3 opacity-75" style="background: red; width: 200px; height: 7px; border: none; margin-top: -23px;"></center>
</div>
 <div class="productos">  
    @foreach ($categorias as $categoria)
 <div class="producto">
  <a href="/todos/{{$categoria->nombre}}" class="a">
  <img src="/categorias/{{$categoria->imagen}}"  alt="Imagenes Cat" class="cat-img"> 
  <br>
   <span class="descripcion">{{$categoria->nombre}}</span>
  </a>
</div>
  @endforeach
  </div> 
