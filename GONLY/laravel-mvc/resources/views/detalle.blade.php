...
<head>
    ...
    <link rel="preload" href="{{asset('css/detalles.css')}}" type="text/css">
...
@foreach ($productos as $detalle)
     <div class="page-title-wrapper" aria-label="Page title">
      <div class="container1">
          ...
          <h1 class="page-title">{{$detalle->nombre}}</h1><span class="d-block mt-2 text-muted"></span>
      </div>
  </div>
    <div class="description">
      <div class="PrecioYCarro">
      <div class="PrecioD">
        <h2 class="PrecioNumero">$ {{$detalle->precio}}</h2>
        <br>
        <h2 class="cate" style="color:blue;">{{$detalle->categoria}}</h2>
      </div>
       <div class="col-sm-6 p-0">
        <form method="POST" action="{{route('cart.add')}}" enctype="multipart/form-data">
            @csrf
               ...
               <br>
            <button class="btn btn-danger btn-block boton-add" type="submit">
                <svg class="carretilla"xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="10px" height="5px"><path fill="currentcolor" d="M96 0C107.5 0 117.4 8.19 119.6 19.51L121.1 32H541.8C562.1 32 578.3 52.25 572.6 72.66L518.6 264.7C514.7 278.5 502.1 288 487.8 288H170.7L179.9 336H488C501.3 336 512 346.7 512 360C512 373.3 501.3 384 488 384H159.1C148.5 384 138.6 375.8 136.4 364.5L76.14 48H24C10.75 48 0 37.25 0 24C0 10.75 10.75 0 24 0H96zM128 464C128 437.5 149.5 416 176 416C202.5 416 224 437.5 224 464C224 490.5 202.5 512 176 512C149.5 512 128 490.5 128 464zM512 464C512 490.5 490.5 512 464 512C437.5 512 416 490.5 416 464C416 437.5 437.5 416 464 416C490.5 416 512 437.5 512 464z"/></svg> 
                Agregar al carrito
            </button>
       ...
       <!-- <div class="DivInformacion">
            <div class="CabezaInfo">
              <img class="IconosInfo" src="https://images.vexels.com/media/users/3/131139/isolated/preview/ff49ce17e1541baa9298514ce6ad37ae-icono-de-circulo-de-informacion.png" alt="... la cambian">
              <hr class="IconoSeparacion">
              <h3 class="letrasInfo">informacion</h3>
            </div>
            <div class="CuerpoInfo">
                <p class="textoInfo"><strong>Generalidades</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra orci sagittis eu volutpat. Consequat interdum varius sit amet.</p>
                <hr class="CuerpoInfoSeparador">
                <div class="UbicacionesInfo">
                <p class="textoInfo"><strong>Especificaciones</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra orci sagittis eu volutpat. Consequat interdum varius sit amet.</p>
              </div>
            </div>
          </div>
        </div>-->
...
<div class="contenedor">
  ...
  <div class="img_container">
      <img src="/productos/{{$detalle->image_path}}" alt="" class="main_img">
  </div>
<!--
  <div class="thumbnail_container">
      <img src="{{asset('img/mouse.png')}}" alt="" class="thumbnail active">
      <img src="{{asset('img/mouse.png')}}" alt="" class="thumbnail">
      <img src="{{asset('img/mouse.png')}}" alt="" class="thumbnail">
