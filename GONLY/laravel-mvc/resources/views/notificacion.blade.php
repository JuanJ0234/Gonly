...
<head>
    ...
    <link rel="preload" type="text/css" href="{{asset('css/notificacion.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/notificacion.css')}}">
    ...
    <footer class="pie-pagina">
        <div class="grupo-1">
            <div class="box">
                <figure>
                    <a href="/home">
                        <img src="{{asset('img/Logo1.png')}}" alt="Logo de GONLY">
                    </a>
                </figure>
            </div>
            <div class="box">
            ...
            <div class="box">
                <div class="box">
                    ...
                    <div class="contactos">
                        <a href="#" class="facebook" target="_blank"><svg class="red-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="23px" height="23px"><path fill="currentColor" d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/></svg></a>
